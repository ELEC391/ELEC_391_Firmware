...
static void verify_icache_init(void);
...
/**
 * @brief Confirms Cacheing is enabled
 *
 * Cacheing is enabled by default -- Hal function verifies there are no issues with config
 *
 */
static void verify_icache_init(void)
{
